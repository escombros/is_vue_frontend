      ...
      <div class="text item">
        ...
        >
          <el-form-item label="CURP" prop="pass">
            <el-input class="elinput" v-model="registro.id" autocomplete="off" />
          </el-form-item>
          ...
          <el-form-item>
            <el-button class="butonclass" type="danger" @click.stop.prevent="registrarUsuario()" plain>Registrar</el-button>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
